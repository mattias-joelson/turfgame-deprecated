...
public class DatabaseEntityManagerTest {
    ...
    public void testUpdateUsers() {
        DatabaseEntityManager entityManager = new DatabaseEntityManager(PERSISTENCE_H2);
        ...
        assertEquals(2, entityManager.getUser("two").getId());
        entityManager.close();
    }
    ...
    public void testUpdateZones() {
        ...
        assertEquals(2, entityManager.getZone("NyZon").getId());
        entityManager.close();
    }
}
