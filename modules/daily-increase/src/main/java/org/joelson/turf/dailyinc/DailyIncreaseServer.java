...
import org.joelson.turf.dailyinc.controller.FeedImporter;
import org.joelson.turf.dailyinc.controller.ProgressUpdater;
...
public class DailyIncreaseServer implements Runnable {

    private static final Path DB_PATH = Path.of("output", "daily-increase");

    private DatabaseEntityManager entityManager = null;
    private boolean shutdown = false;

    public static void main(String[] args) throws IOException {
        DailyIncreaseServer server = new DailyIncreaseServer();
