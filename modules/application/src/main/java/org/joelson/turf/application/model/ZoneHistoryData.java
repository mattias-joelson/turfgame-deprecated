...
public class ZoneHistoryData implements Serializable {
    ...
    public ZoneHistoryData(
            int id, Instant from, String name, RegionData region, Instant dateCreated, double latitude,
            double longitude) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ZoneHistoryData that) {
            return id == that.id && Objects.equals(name, that.name) && Objects.equals(from, that.from)
    ...
    public String toString() {
        return String.format(
                "ZoneHistoryData[id %d, from %s, name %s, region %s, dateCreated %s, latitude %f, longitude %f]",
