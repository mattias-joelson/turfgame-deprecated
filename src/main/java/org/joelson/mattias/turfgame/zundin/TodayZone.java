...
public class TodayZone {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof TodayZone) {
            TodayZone that = (TodayZone) obj;
            return date.equals(that.getDate()) && Objects.equals(eagerTime, that.getEagerTime())
                    && zoneName.equals(that.getZoneName()) && areaName.equals(that.getAreaName())
                    && tp == that.getTP() && pph == that.getPPH() && activity.equals(that.getActivity())
                    && userId.equals(that.getUserId()) && take == that.getTake();
        }
