...
public class MonthlyZone {
    ...
    public MonthlyZone(String name, int tp, int pph, String municipality, int points, Duration averageDuration, int takes, int revisits, int assists) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof MonthlyZone) {
            ...
            return name.equals(that.getName()) && municipality.equals(that.getMunicipality())
                    ...
                    && points == that.getPoints() && averageDuration.compareTo(that.getAverageDuration()) == 0
    ...
    public static MonthlyZone fromHTML(String html) {
        ...
        return new MonthlyZone(namePosition.stringValue(), tpPosition.integerValue(), pphPosition.integerValue(), municipalityPosition.stringValue(),
                pointsPosition.integerValue(), averageDurationPosition.durationValue(), takesPosition.integerValue(), revisitsPosition.integerValue(),
